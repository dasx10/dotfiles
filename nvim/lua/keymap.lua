...
vim.api.nvim_set_keymap('n', '<silent><leader>gg', ':Git<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<silent><leader>gA', ':Git add -A<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<silent><leader>gd', ':Git diff<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<silent><leader>gds', ':Gdiffsplit<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<silent><leader>gl', ':Git log<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<silent><leader>gs', ':Git status<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<leader>gf', ':Git fetch<CR>', {})

-- Searching
vim.api.nvim_set_keymap('n', '<silent><leader>od', '<Plug>(coc-definition)', {silent = true})
vim.api.nvim_set_keymap('n', '<silent><leader>ot', '<Plug>(coc-type-definition)', {silent = true})
vim.api.nvim_set_keymap('n', '<silent><leader>oi', '<Plug>(coc-implementation)', {silent = true})
vim.api.nvim_set_keymap('n', '<silent><leader>or', '<Plug>(coc-references)', {silent = true})
vim.api.nvim_set_keymap('n', '<silent><leader>oc', ':copen<CR>', {silent = true})
vim.api.nvim_set_keymap('n', '<silent><leader>og', ':registers<CR>', {silent = true})
vim.api.nvim_set_keymap('n', '<silent><leader>/', ':nohlsearch<CR>', {silent = true})
...
-- Other
vim.api.nvim_set_keymap('n', '<silent><Home>', ':1<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<silent><End>', ':$<CR>', {noremap = true})
vim.api.nvim_set_keymap('x', '<silent><Home>', ':1<CR>', {noremap = true})
vim.api.nvim_set_keymap('x', '<silent><End>', ':$<CR>', {noremap = true})
