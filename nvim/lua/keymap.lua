...
vim.api.nvim_set_keymap('n', '<leader>g<space>', ':Git blame<cr>', {})
vim.api.nvim_set_keymap('n', '<leader>gA',       ':Git add -A<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<leader>ga',       ':Git add<space>', { silent = true })
vim.api.nvim_set_keymap('n', '<leader>gP',       ':Git pull<space>', {})
vim.api.nvim_set_keymap('n', '<leader>gPo',      ':Git pull origin<space>', {})
vim.api.nvim_set_keymap('n', '<leader>gPP',      ':!git pull origin $(git branch --show-current)<cr>', {})
vim.api.nvim_set_keymap('n', '<leader>gmm',      ':!git pull origin $(git branch --show-current) && git merge origin $(git branch --show-current)<cr>', {})
vim.api.nvim_set_keymap('n', '<leader>gp',       ':Git push<space>', {})
vim.api.nvim_set_keymap('n', '<leader>gpo',      ':Git push origin<space>', {})
vim.api.nvim_set_keymap('n', '<leader>gpp',      ':!git push origin $(git branch --show-current)<cr>', {})
...
vim.api.nvim_set_keymap('n', '<leader>gdh',      ':Gdiffsplit<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<leader>gds',      ':Gvdiffsplit<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<leader>gdv',      ':Gdiffsplit<CR>', { silent = true })
...
vim.api.nvim_set_keymap('n', '<leader>gn',       ':Git checkout -b<space>', {})
vim.api.nvim_set_keymap('n', '<leader>go',       ':Git checkout<space>', {})
vim.api.nvim_set_keymap('n', '<leader>gr',       ':Git rebase<space>', {})
vim.api.nvim_set_keymap('n', '<leader>gro',      ':Git push origin :<left>', {})
...
vim.api.nvim_set_keymap('n', "<leader>f'", ':Telescope marks<cr>', { silent = true })
...
-- ALT MAP
vim.api.nvim_set_keymap('n', '<A-k>', ':lua ToUpRecursive()<cr>==',   {silent=true, noremap = true })
vim.api.nvim_set_keymap('n', '<A-j>', ':lua ToDownRecursive()<cr>==', {silent=true, noremap = true })
vim.api.nvim_set_keymap('n', '<A-g>', ':move 0<CR>==',                {silent=true, noremap = true })
vim.api.nvim_set_keymap('n', '<A-l>', "m0I\t<esc>`0",                 {silent=true, noremap = true })
vim.api.nvim_set_keymap('n', '<A-h>', "m0^2dh`0",                     {silent=true, noremap = true })
vim.api.nvim_set_keymap('n', '<A-n>', "m0yyp`0j",                     {silent=true, noremap = true })
vim.api.nvim_set_keymap('n', '<A-p>', "m0yyP`0k",                     {silent=true, noremap = true })
vim.api.nvim_set_keymap('n', '<A-d>', "<Plug>(coc-range-select)",     {silent=true, noremap = true })
vim.api.nvim_set_keymap('n', '<A-n>', ':move<space>',                 {silent=true, noremap = true })

vim.api.nvim_set_keymap('v', '<A-k>', ":move -2<cr>gv=gv",  { silent=true, noremap = true })
vim.api.nvim_set_keymap('v', '<A-j>', ":move'>+<cr>gv=gv",  { silent=true, noremap = true })
...
vim.api.nvim_set_keymap('n', 'vv', '0v$', {})
...
vim.api.nvim_set_keymap('n', '<C-space>', ':call CocActionAsync("doHover")<CR>', {})
vim.api.nvim_set_keymap('n', '<leader>vn', ':lua CheckboxRelative()<cr>', {silent = true})
vim.api.nvim_set_keymap('n', '<leader>vc', ':lua CheckboxSpaceHighlight()<cr>', {silent = true})
